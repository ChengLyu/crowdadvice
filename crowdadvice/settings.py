# Django settings for crowdadvice project.
import os
...
LOGIN_REDIRECT_URL = 'adviceapp:mentorworksignup'
...
SECRET_KEY = '23$wy%nyzym%_bs0$2b_9-f6h9-oj3y0*v6o)84z==#5q8mul7'
...
ROOT_URLCONF = 'crowdadvice.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'crowdadvice.wsgi.application'
